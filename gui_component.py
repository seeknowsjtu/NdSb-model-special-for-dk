...
PARAMETER_FORM_SPECS = (
    ...
    ParameterSpec("Basic", "Pump", "dt0_ps", "Global time-zero dt0 (ps)"),
    ParameterSpec("Basic", "Pump", "sigma_irf_ps", "IRF sigma (ps)"),
    ParameterSpec("Basic", "Pump", "alpha_dt_per_F", "dt slope vs fluence (ps/F)"),
